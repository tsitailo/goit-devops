...
output "prometheus_url_command" {
  description = "Команда для доступу до Prometheus (port-forward)"
  value       = module.monitoring.prometheus_url_command
}

output "grafana_url_command" {
  description = "Команда для доступу до Grafana (port-forward)"
  value       = module.monitoring.grafana_url_command
}

output "grafana_password_command" {
  description = "Команда для отримання пароля адміна Grafana"
  value       = module.monitoring.grafana_password_command
}